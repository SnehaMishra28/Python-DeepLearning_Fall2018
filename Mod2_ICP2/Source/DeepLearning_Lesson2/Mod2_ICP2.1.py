...
def basic_model_1(x_size, y_size):
    ...
    t_model.add(Dense(20, activation="relu"))   #Model 3, extra hidden layer
...
plt.title('model loss - model 3 (epoch 200)')
plt.ylabel('loss')
plt.xlabel('epoch')
...
#plt.scatter(arr_x_train, arr_y_train)
plt.plot(arr_x_train,arr_y_train)
plt.show()

#plt.scatter(arr_x_valid, arr_y_valid)
plt.plot(arr_x_valid,arr_y_valid)
plt.show()
